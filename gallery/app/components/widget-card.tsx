					...
					{widget.tags && widget.tags.length > 0 && (
						<div className="mb-4 flex flex-wrap gap-1">
							{widget.tags.map((tag) => (
								<span
									key={tag}
									className="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-gray-100 text-gray-800 dark:bg-gray-700 dark:text-gray-200 transition-all duration-200 select-none"
								>
									{tag}
								</span>
							))}
